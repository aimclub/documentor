...
| Dataset<br>ID | Therapeutic<br>Area | N      | Year    | Sex Ratio<br>Female:Male | Younger Group<br>Age Range | Elder Group<br>Age Range |
|---------------|---------------------|--------|---------|--------------------------|----------------------------|--------------------------|
...
$$\begin{aligned} & \text{min} & & N_{add} \\ & \text{s.t.} & & h(N_p + N_{add}) = f(N_p) \end{aligned}$$
...
| $D_1$    | -                        | -               | -            | $0.65 \pm 0.04$ | $0.69 \pm 0.05$          | < 0.0001 *** |  |  |
| $D_{2a}$ | $0.59 \pm 0.02$          | $0.61 \pm 0.02$ | < 0.0001 *** | $0.58 \pm 0.02$ | $0.62 \pm 0.02$          | < 0.0001 *** |  |  |
| $D_{2b}$ | $0.59 \pm 0.02$          | $0.59 \pm 0.02$ | 0.67         | $0.58 \pm 0.02$ | $0.60 \pm 0.02$          | < 0.0001 *** |  |  |
| $D_3$    | $0.66 \pm 0.07$          | $0.71 \pm 0.06$ | < 0.0001 *** | $0.63 \pm 0.06$ | $0.73 \pm 0.06$          | < 0.0001 *** |  |  |
| $D_4$    | $0.77 \pm 0.04$          | $0.78 \pm 0.06$ | 0.80         | $0.79 \pm 0.05$ | $0.79 \pm 0.06$          | 0.95         |  |  |
| $D_5$    | $0.53 \pm 0.02$          | $0.56 \pm 0.02$ | < 0.0001 *** | $0.54 \pm 0.02$ | $0.50 \pm 0.01$          | < 0.0001 *** |  |  |
| $D_6$    | $0.92 \pm 0.01$          | $0.87 \pm 0.02$ | < 0.0001 *** | $0.87 \pm 0.02$ | $0.91 \pm 0.01$          | < 0.0001 *** |  |  |
| $D_{7a}$ | $0.68 \pm 0.03$          | $0.67\pm0.03$   | < 0.01 *     | $0.62 \pm 0.03$ | $0.69 \pm 0.03$          | < 0.0001 *** |  |  |
| $D_{7b}$ | $\textbf{0.71} \pm 0.02$ | $0.67 \pm 0.03$ | < 0.0001 *** | $0.66 \pm 0.02$ | $\textbf{0.70} \pm 0.03$ | < 0.0001 *** |  |  |
...
(b) AUC-Complexity Consistencies by Age
...
| Dataset  |         | Sex    |       |         | Age   |         |         |   |
|----------|---------|--------|-------|---------|-------|---------|---------|---|
|          | Overall | Female | Male  | KS-test | Elder | Younger | KS-test |   |
| $D_1$    | 0.243   | -      | -     | -       | 0.247 | 0.172   | 0.205   | * |
...
| $D_5$    | 0.119   | 0.105  | 0.119 | 0.060   | 0.169 | 0.069   | 0.299   | * |
| $D_6$    | 0.084   | 0.083  | 0.078 | 0.031   | 0.078 | 0.085   | 0.024   |   |
| $D_{7a}$ | 0.266   | 0.244  | 0.233 | 0.053   | 0.263 | 0.233   | 0.082   | * |
| $D_{7b}$ | 0.269   | 0.247  | 0.250 | 0.049   | 0.262 | 0.228   | 0.088   | * |
...
Data Availability A version of the datasets used during the current study that has been pre-processed for reproducibility is available in the following repository, including pointers to the original datasets: https://github.com/IoannisBil/health\_disparities\_Chronic\_Diseases/blob/main/README.md

### References

- 1. Fogel AL, Kvedar JC. Artificial intelligence powers digital medicine. NPJ digital medicine. 2018;1(1):5.
- Jusman Y, Firdiantika IM, Dharmawan DA, Purwanto K. Performance of multi layer perceptron and deep neural networks in skin cancer classification. In: 2021 IEEE 3rd global conference on life sciences and technologies (LifeTech). IEEE; 2021. p. 534-8.
- Lo B, Malina D, Pittman G, Morrissey S. Fundamentals of medical ethics—A new perspective series. Mass Medical Soc; 2023.
...
- Hajian S, Bonchi F, Castillo C. Algorithmic bias: From discrimination discovery to fairness-aware data mining. In: Proceedings of the 22nd ACM SIGKDD international conference on knowledge discovery and data mining; 2016. p. 2125-6.
- Raza S. Connecting fairness in machine learning with public health equity. In: 2023 IEEE 11th International Conference on Healthcare Informatics (ICHI). IEEE; 2023. p. 704-8.

- Lippert-Rasmussen K. Born free and equal?: A philosophical inquiry into the nature of discrimination. Oxford University Press; 2013.
...
- Hardesty L. Study finds gender and skin-type bias in commercial artificial-intelligence systems. Retrieved April. 2018;3:2019.
...
- Halamka J, Bydon M, Cerrato P, Bhagra A. Addressing racial disparities in surgical care with machine learning. NPJ Digital Medicine. 2022;5(1):152.
- 17. Drukker K, Chen W, Gichoya J, Gruszauskas N, Kalpathy-Cramer J, Koyejo S, et al. Toward fairness in artificial intelligence for medical image analysis: identification and mitigation of potential biases in the roadmap from data collection to model deployment. Journal of Medical Imaging. 2023;10(6):061104-4.
- Larrazabal AJ, Nieto N, Peterson V, Milone DH, Ferrante E. Gender imbalance in medical imaging datasets produces biased classifiers for computer-aided diagnosis. Proceedings of the National Academy of Sciences. 2020;117(23):12592-4.
- Seyyed-Kalantari L, Liu G, McDermott M, Chen IY, Ghassemi M. CheXclusion: Fairness gaps in deep chest X-ray classifiers. In: BIOCOMPUTING 2021: proceedings of the Pacific symposium. World Scientific; 2020. p. 232-43.
- Chen IY, Szolovits P, Ghassemi M. Can AI help reduce disparities in general medical and mental health care? AMA journal of ethics. 2019;21(2):167-79.
...
- Anderson JW, Shaikh N, Visweswaran S. Measuring and reducing racial bias in a pediatric urinary tract infection model. AMIA Summits on Translational Science Proceedings. 2024;2024:488.
- 30. Suresh H, Guttag J. A framework for understanding sources of harm throughout the machine learning life cycle. In: Equity and access in algorithms, mechanisms, and optimization; 2021. p. 1-9.
- Ahmad MA, Patel A, Eckert C, Kumar V, Teredesai A. Fairness in machine learning for healthcare. In: Proceedings of the 26th ACM SIGKDD international conference on knowledge discovery & data mining; 2020. p. 3529-30.
...
- 33. Raji ID, Buolamwini J. Actionable auditing: Investigating the impact of publicly naming biased performance
...
- 41. Bilionis I, Fernandez-Luque L, Castillo C. A survey on public data sets related to chronic diseases. In: 2023 IEEE 36th International Symposium on Computer-Based Medical Systems (CBMS). IEEE; 2023. p. 917-20.
...
- Gupta N, Mujumdar S, Patel H, Masuda S, Panwar N, Bandyopadhyay S, et al. Data quality for machine learning tasks. In: Proceedings of the 27th ACM SIGKDD conference on knowledge discovery & data mining; 2021. p. 4040-1.
