...

{
  ...
  "captions": [
    {
      "text": "Таблица 9: tblGenFuncContainsProf",
      "table_number": 9,
      "bbox": [
        446,
        1062,
...
|---:|:--------------------|:--------|:---------------------|:---------------------------------|
|  0 | idContainsAction    | int     | PK                   | Идентификатор                    |
|  1 | idLaborFunc         | int     | FK(tblLa- borFunc)   | Идентификатор трудовой функции   |
|  2 | idLaborAction       | int     | FK(tblLa- borAction) | Идентификатор трудового действия |
