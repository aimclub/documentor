"""
Скрипт для запуска эксперимента по сопоставлению таблиц на всех DOCX файлах.
"""
...
from experiments.pdf_text_extraction.docx_table_matching_experiment import process_table_experiment
...
def main():
    ...
    print(f"\n{'='*80}")
    print(f"Запуск эксперимента по сопоставлению таблиц на всех DOCX файлах")
    ...
    for r in results_summary:
        if r.get("status") == "success":
            ...
            print(f"    Средняя схожесть: {r.get('average_similarity', 0.0):.2%}")
        else:
